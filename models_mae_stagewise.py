...
class StagewiseMaskedAutoencoderViT(nn.Module):
...
def stagewise_mae_vit_base_patch16_dec512d8b(**kwargs):
    model = StagewiseMaskedAutoencoderViT(
...
def stagewise_mae_vit_large_patch16_dec512d8b(**kwargs):
    model = StagewiseMaskedAutoencoderViT(
...
def stagewise_mae_vit_huge_patch14_dec512d8b(**kwargs):
    model = StagewiseMaskedAutoencoderViT(
...
stagewise_mae_vit_base_patch16 = stagewise_mae_vit_base_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
stagewise_mae_vit_large_patch16 = stagewise_mae_vit_large_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
stagewise_mae_vit_huge_patch14 = stagewise_mae_vit_huge_patch14_dec512d8b  # decoder: 512 dim, 8 blocks
