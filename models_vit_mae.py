...
class ViTwMAE(nn.Module):
    """ Masked Autoencoder with VisionTransformer backbone
        Can do both classification and reconstruction.
    """
    ...
    def forward_features(self, x, mask_ratio):
        ...
        features_wo_cls_token = features[:, 1:, :]
        masked_features_wo_cls_token, mask, ids_restore = self.random_masking(features_wo_cls_token, mask_ratio)
        masked_features = torch.cat((cls_token, masked_features_wo_cls_token), dim=1)
        ...
        return masked_features, mask, ids_restore, outcome
